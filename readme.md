...
```bash
 sudo pacman -S waybar swww rofi hyprlock fish fastfetch sddm kitty make cmake base-devel git nano python-pyquery grim slurp nwg-look nautilus font-manager blueman nm-connection-editor --needed
```
